...
input_dir='../../JL20240124_FemaleMaleRNAseqDifferential/star_align/'
...
# Output directory 
output_dir='../JL20240124_FemaleRNAseq_first_of_pair_strand_coverage/'
...
# Filter the .bam files containing the substring "sortedByCoord" and start with "F"
bam_files=($(ls "$input_dir"F*sortedByCoord.out.bam 2>/dev/null))
